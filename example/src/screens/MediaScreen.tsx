  ...
  return (
    <Box flex={1} bg="#FFFFFF">
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 50 }}>
        <Heading level={2} style={{ marginBottom: 20 }}>Media Components</Heading>

        <Box mb={30}>
          <Heading level={5} style={{ marginBottom: 10 }}>Smart Image (with fade-in)</Heading>
          <SmartImage
        ...
        <Box mb={30}>
          <Heading level={5} style={{ marginBottom: 10 }}>Spinner</Heading>
          <Row gap={20}>
        ...
        <Box mb={30}>
          <Heading level={5} style={{ marginBottom: 10 }}>Zoomable View (Pinch/Pan)</Heading>
          <Box height={200} bg="#F3F4F6" style={{ borderRadius: 12, overflow: 'hidden' }}>
            <ZoomableView>
              <SmartImage
        ...
        <Box mb={30}>
          <Heading level={5} style={{ marginBottom: 10 }}>Avatar Stack</Heading>
          <AvatarStack
            avatars={[
